...
export function ChincheMadera(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/components/ChincheMadera/ChincheMadera.gltf')
...
useGLTF.preload('/components/ChincheMadera/ChincheMadera.gltf')
