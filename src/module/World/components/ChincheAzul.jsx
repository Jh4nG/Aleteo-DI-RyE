...
export function ChincheAzul(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/components/ChincheColors/ChincheAzul.gltf')
...
useGLTF.preload('/components/ChincheColors/ChincheAzul.gltf')
