...
export function ChincheVerde(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF('/components/ChincheColors/ChincheVerde.gltf')
...
useGLTF.preload('/components/ChincheColors/ChincheVerde.gltf')
